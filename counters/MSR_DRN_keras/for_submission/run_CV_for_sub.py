...
def main(args=None):
    ...
    args.save_res_path = os.path.join(GetEnvVar('ExpResultsPath'), 'LCC_exp_res', args.pipe, "results",
                                      "results_" + args.pipe +'_Faina_exp_2'+".csv")
    ...
    for cv_fold in range(1, num_of_CV + 1):
        ...
        #
        #
        #     args.model = os.path.join(GetEnvVar('ModelsPath'), 'LCC_Models_senepshots', args.pipe, 'exp_' + str(args.exp_num),
        #                               'cv_'+str(cv_fold), 'resnet50_csv.h5')
        #
        #
        #     if args.pipe == 'keyPfinder':
