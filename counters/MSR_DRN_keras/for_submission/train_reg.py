...
if __name__ == '__main__':
    ...
    # path to the annotation files, includes train and val files
    # for the direct regression counting and detection based counting
    # (that organized as the data in the below folder)
    # args.train_csv_leaf_number_file = os.path.join(args.data_path, '{}_Train'.format(args.dataset), '{}_Train.csv'.format(args.dataset))
    # args.train_csv_leaf_location_file = os.path.join(args.data_path, '{}_Train'.format(args.dataset), '{}_Train_leaf_location.csv'.format(args.dataset))
    # args.val_csv_leaf_number_file = os.path.join(args.data_path, '{}_Val'.format(args.dataset), '{}_Val.csv'.format(args.dataset))
    # args.val_csv_leaf_location_file = os.path.join(args.data_path, '{}_Val'.format(args.dataset), '{}_Val_leaf_location.csv'.format(args.dataset))
    ...
    if args.dataset == 'BL':
        ...
        args.train_csv_leaf_number_file = os.path.join(args.data_path, args.dataset+'_Train', args.dataset+'_Train.csv')
        args.train_csv_leaf_location_file = os.path.join(args.data_path, args.dataset+'_Train', args.dataset+'_Train_leaf_location.csv')
        args.val_csv_leaf_number_file = os.path.join(args.data_path, args.dataset+'_Val', args.dataset+'_Val.csv')
        args.val_csv_leaf_location_file = os.path.join(args.data_path, args.dataset+'_Val', args.dataset+'_Val_leaf_location.csv')
    else:
